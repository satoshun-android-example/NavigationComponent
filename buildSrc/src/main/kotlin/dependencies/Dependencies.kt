...
const val ACTIVITYX = "androidx.activity:activity-ktx:1.2.0-alpha07"
const val FRAGMENTX = "androidx.fragment:fragment-ktx:1.3.0-alpha07"

const val APPCOMPAT = "androidx.appcompat:appcompat:1.2.0-rc02"
