...
private const val VNAVIGATION = "2.1.0-beta02"

const val ANDROID_PLUGIN = "com.android.tools.build:gradle:3.5.0-rc01"
...
const val VIEWMODEL = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.2.0-alpha02"
const val LIVEDATA = "androidx.lifecycle:lifecycle-livedata-ktx:2.2.0-alpha02"
...
const val LIFECYCLE_RUNTIME = "androidx.lifecycle:lifecycle-runtime-ktx:2.2.0-alpha02"
